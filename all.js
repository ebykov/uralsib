  ...
  _createClass(Special, [{
    ...
    value: function answer(t) {
      ...
      if (question.correct === type) {
        ...
        EL.cAnswerTitle.innerHTML = question.correctTitle;
        EL.cAnswerText.innerHTML = question.correctMsg;
      } else {
        EL.q.classList.add('is-incorrect');
        EL.cAnswerTitle.innerHTML = question.incorrectTitle;
...
exports.default = {
  ...
  questions: [{
    ...
    text: 'Молодой человек взял с собой в автобусную поездку ноутбук, чтобы поработать. В начале пути он заметил, что забыл дома флешку с материалами.',
    correctMsg: 'Ему пришла в голову идея создать сервис облачного хранения данных — так появился Dropbox. Герой этой истории теперь долларовый миллиардер.',
    incorrectMsg: 'Герой этой истории придумал сервис Dropbox, чтобы хранить нужные файлы в облаке. ',
    correctTitle: 'Вы правы, это бизнес',
    incorrectTitle: 'Вы не правы, это бизнес',
    correct: 'right',
    info: {
    ...
    text: 'У молодого журналиста не было возможности отыскать контакты нужного героя, и он отдал в печать интервью, которое целиком выдумал сам.',
    correctMsg: 'К бизнесу это не имеет отношения, но создателям кинокомедии «Фантомас», из которой взят этот сюжет, удалось хорошо заработать на кассовых сборах в СССР.',
    incorrectMsg: 'Это завязка кинокомедии «Фантомас».',
    correctTitle: 'Правильно, завязка фильма',
    incorrectTitle: 'Неверно, фильм',
    correct: 'left',
    info: {
    ...
    text: 'Юноша увлекался коллекционированием: с детства собирал комиксы, бейсбольные карточки, автографы. Их он брал даже у своих одноклассников в надежде, что они станут знаменитыми.',
    correctMsg: 'После продажи своей гигантской коллекции Джо Маддалена открыл аукцион памятных вещей Profiles In History. Бластер со съёмок «Звёздных войн» там продали за $240 тысяч.',
    incorrectMsg: 'Это мог быть фильм про страсть коллекционирования, но стало идеей для организации аукциона памятных вещей Profiles In History.',
    correctTitle: 'Да! Это бизнес',
    incorrectTitle: 'Неверно, это бизнес-история',
    correct: 'right',
    info: {
    ...
    text: 'Домохозяйка нашла необычное применение мешку, набитому кукурузными зёрнами.',
    correctMsg: 'Бизнес, но без попкорна. Из небольшого мешка, разогретого в микроволновке, получилась тёплая спа-подушка Wuvit, которую позже запатентовали.',
    incorrectMsg: 'Попкорн — классический атрибут кинематографа, но это реальная история создания спа-подушек, которые можно разогревать в микроволновке.',
    correctTitle: 'Да, это бизнес',
    incorrectTitle: 'Неверно, это бизнес',
    correct: 'right',
    info: {
    ...
    text: 'Американец задумался, может ли посуда отражать черты характера её владельца.',
    correctMsg: 'У главного героя фильма «Бойцовский клуб» была настолько невзрачная жизнь, что он тратил время на тщательный подбор сервиза в каталоге.',
    incorrectMsg: 'Всего лишь метафора серой жизни главного героя фильма «Бойцовский клуб».',
    correctTitle: 'Вы правы, это фильм',
    incorrectTitle: 'Вы не правы, это из фильма',
    correct: 'left',
    info: {
    ...
    text: 'Американец шил плюшевых медведей, но магазины отказывались их распространять из-за мелкосерийного производства.',
    correctMsg: 'Столь редкие игрушки стали коллекционными. На вторичном рынке цена на мишек Beanie Babies доходила до $5 тысяч, при себестоимости в $10.',
    incorrectMsg: 'Звучит странно, но предприниматель Тай Уорнер продавал в каждый магазин не более 36 игрушек в месяц, из-за чего те стали коллекционными и сделали его компанию известной.',
    correctTitle: 'Верно, это бизнес',
    incorrectTitle: 'Нет, это бизнес',
    correct: 'right',
    info: {
    ...
    text: 'Безработный американец побрезговал мыть свой ковёр.',
    correctMsg: '«Ковёр задавал стиль всей комнате!» — знаменитая реплика героя фильма «Большой Лебовски». В походе за новым ковром начинаются все его приключения.',
    incorrectMsg: 'Бандиты вломились к главному герою фильма «Большой Лебовски» и испортили ему любимый ковёр. Это стало началом всех его приключений.',
    correctTitle: 'Правильно, это сюжет из фильма',
    incorrectTitle: 'Неверно, это фильм',
    correct: 'left',
    info: {
    ...
    text: 'Компания калифорнийца разорилась и он берёт передышку: уезжает в Австралию кататься на сёрфе и снимать видео.',
    correctMsg: 'Снимать экшн-видео было сложно — хорошую съёмку могли позволить себе только профессионалы. Так родилась идея сделать камеру GoPro.',
    incorrectMsg: 'По словам основателя компании Ника Вудмана, без сёрфинга ему никогда бы не пришла идея сделать GoPro — камеру для экстремальных съёмок.',
    correctTitle: 'Точно! Это бизнес',
    incorrectTitle: 'Это не фильм',
    correct: 'right',
    info: {
    ...
    text: 'Житель Нью-Йорка часто переезжал и испытывал трудности с перевозкой своего комнатного растения.',
    correctMsg: 'Цветок в горшке — атрибут главного героя из фильма «Леон». Это метафора «кочевого» образа жизни героя.',
    incorrectMsg: 'За цветком ухаживал главный герой фильма «Леон». Это единственное живое существо, о котором он заботился.',
    correctTitle: 'Всё верно, это фильм',
    incorrectTitle: 'Увы, это фильм',
    correct: 'left',
    info: {
    ...
    text: 'В Сан-Франциско проходила крупная конференция, из-за наплыва посетителей невозможно было найти место в отелях. Предприимчивые друзья заработали на этом $240.',
    correctMsg: 'Они подселили незнакомцев и продали им три места на надувных матрасах. Это первый заработок проекта Airbnb.',
    incorrectMsg: 'Так началась десятилетняя история компании Airbnb.',
    correctTitle: 'Правильно, это бизнес-история',
    incorrectTitle: 'Вы не правы, это бизнес',
    correct: 'right',
    info: {
